...
public class Settings extends JFrame {
	...
	ArrayList<Boolean> optionBox = new ArrayList<Boolean>(); // create arrayList
																// of the above
																// booleans
	ArrayList<JCheckBox> options = new ArrayList<JCheckBox>(); // create
																// arraylist of
																// checkboxes
	...
	public Settings(String theName) {
		...
		gameplay.setBorder(BorderFactory.createTitledBorder("Gameplay"));
