...
public class Game extends AbstractDraw implements KeyListener {
	...
	public Game(String theName, GameWindow theWindow, int ident) {
		...
		player = new Player(15, new Point2D.Double(
				(int) (Math.random() * 5000), (int) (Math.random() * 5000)));
	...
	public void draw(Graphics2D g2d) {
		...
		if (keys[KeyEvent.VK_D]) {
			g2d.setColor(Color.BLACK);
			g2d.fillRect(0, (int) (this.getBounds().getHeight() - 90),
					(int) (this.getBounds().getWidth()), 90);
			Rectangle debugPanel = new Rectangle(0, (int) (this.getBounds()
			...
			g2d.drawString(
					Double.toString(position.getX() - this.getWidth() / 2),
					125, (int) (debugPanel.getMinY() + 60));
			g2d.drawString("deltaY: ", 30, (int) (debugPanel.getMinY() + 75));
			g2d.drawString(
					Double.toString(position.getY() - this.getHeight() / 2),
					125, (int) (debugPanel.getMinY() + 75));
		}

		if (keys[KeyEvent.VK_CONTROL]) {
			g2d.setColor(Color.BLACK);
			g2d.fillRect((int) (this.getBounds().getWidth() * 0.01),
					this.getHeight() / 4, 160, 140);
			Rectangle controlPanel = new Rectangle((int) (this.getBounds()
