...
public class Player extends Cell {
	...
	public void moveAndDraw(Graphics2D g2d) {
		...
		g2d.fillOval((int) Math.round(super.getLocation().getX()
				- super.getRadius()), (int) Math.round(super.getLocation()
				.getY() - super.getRadius()), (int) Math.round(super
				.getRadius() * 2), (int) Math.round(super.getRadius() * 2)); // draws
																				// new
																				// oval
		...
		int smallTextWidth = (int) (smallFont.getStringBounds("(#" + id + ")",
				frc).getWidth());
		int smallTextHeight = (int) (smallFont.getStringBounds("(#" + id + ")",
				frc).getHeight());
		g2d.setFont(smallFont);
		g2d.drawString("(#" + id + ")", (int) this.getLocation().getX()
				- (smallTextWidth / 2),
				(int) (this.getLocation().getY() + (smallTextHeight / 0.8)));
	}
